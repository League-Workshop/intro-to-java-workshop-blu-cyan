...
Juni.microMove(10);
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = Juni.getX();
		int robotYLocation = Juni.getY();
		...
		JOptionPane.showMessageDialog(null, "Find the pirate that is alergic to water.");
		// 8. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
		if(robotXLocation>570&&robotXLocation>610&&robotYLocation<420&&robotYLocation>300) {
			JOptionPane.showMessageDialog(null, "Find my beloved friend flying with his feathered family.");
		}
		// 9.  If the robot is in the final location
		//     --call the treasureFound() method
		if(robotXLocation>570&&robotXLocation<680&&robotYLocation>110&&robotYLocation<170){
			treasureFound();
		}
	}
